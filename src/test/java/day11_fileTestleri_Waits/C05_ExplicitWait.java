...
public class C05_ExplicitWait {
    ...
    public void test01(){
        ...
        driver.findElement(By.xpath("//*[text.txt()='Remove']")).click();
        ...
        driver.findElement(By.xpath("//*[text.txt()='Add']")).click();
        //7. It’s back mesajinin gorundugunu test edin
        // it's back yazisinin cikmasi ve bizim locate etmemiz icin beklememiz gerekiyor

        WebElement itsBackElementi =
                wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[text.txt()=\"It's back!\"]")));
