...
public class C01_BeforeAfterNotasyonlari {
    ...
    //26.satiri WebDriver driver = new ChromeDriver(); seklinde yaparsak
    // driver setup methodunun icinde olusturuldugu icin sadece o methodda kullanilir.

    public void setup(){ // her method icin teker teker yapmak yerine
    ...
    public void amazonTest(){
        // 1- Amazon anasayfaya gidip, url'in amazon icerdigini test edin,sayfayi kapatin
        setup(); // setup methodunu cagirdim
