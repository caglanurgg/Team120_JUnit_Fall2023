...
public class C02_BeforeAfterNotasyonlari {
    ...
    //**Before ve After Notasyonlarina sahip methodlar TEST METHODLARINA BAGIMLIDIR.

    // Q: 3 test method'u olusturup asagidaki gorevleri
    ...
    WebDriver driver;
    @Before // @Test method'larinda CAGIRMAYA GEREK OLMADAN method
           // her test method'undan once calisir
    public void setup(){
    ...
    @After // her test Method'undan sonra calismasini istedigimiz
           // siradan bir method varsa @After notasyonu ile isaretleyebiliriz
