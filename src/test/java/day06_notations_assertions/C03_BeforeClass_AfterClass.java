...
public class C03_BeforeClass_AfterClass {
    ...
    /*
        Bize verilen gorevde olusturulacak farkli test method'lari
        ayni web sayfasinda oluyorsa her test method'unda yeniden driver olusturup,
   ...
   // uc urun alacaksan uc defa bakkala gitmektense bir kere git uc urunu de al
    ...
    public void javaTest(){
        //*3- Arama kutusuna "Java" yazip aratin ve sonucun Java icerdigini test edin
        WebElement aramaKutusu = driver.findElement(By.id("twotabsearchtextbox"));
        aramaKutusu.clear(); //NutellaJava olmasin diye
